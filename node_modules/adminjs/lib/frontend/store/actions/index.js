...
var _setDrawerPreroute = require("./set-drawer-preroute");
Object.keys(_setDrawerPreroute).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _setDrawerPreroute[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _setDrawerPreroute[key];
    }
  });
});